...
# # Create mask of duplicates (excluding the first occurrence)
...
# Exclude label column from similarity check
features = df.drop(columns=["Stage"]).values
labels = df["Stage"].values

# Parameters
similarity_threshold = 0.8   # 80% of columns must match
